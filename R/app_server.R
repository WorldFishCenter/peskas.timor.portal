...
app_server <- function(input, output, session) {
  ...
  mod_region_conservation_server(id = "region-conservation", xvar = municipality, yvar = perc, fillvar = catch_preservation, legend_position = "top", legend_align = "center", legend_fontsize = 16, col_length = 5, y_formatter = V8::JS('function(x) {return x + "%"}'), i18n_r = i18n_r)
